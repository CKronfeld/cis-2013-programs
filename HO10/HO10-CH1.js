...
var passwordCheckOld = function () 
{
  ...
  {
   stringOutput = "Password must be atleast 8 characters!";
  }
  else
  {
   for (var counter = 0; counter < arrayBadPasswords.length; counter++)
   {
    if (stringPassword === arrayBadPasswords[counter])
    {
        stringOutput = "Password failed!";
        break;
    }
    else
    {
      stringOutput = "That will do.";
    }
   }
  }
